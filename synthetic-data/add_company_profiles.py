"""
Add Company Profile documents to existing output WITHOUT deleting anything.
This script will ONLY generate company_profile documents for all companies.
"""
import os
import pandas as pd
import json
...
def main():
    """
    Generate ONLY company profile documents and add them to existing output.
    Does NOT delete or overwrite any existing documents.
    """
    # Paths
    ...
    if existing_profiles:
        print(f"\n⚠️  Found {len(existing_profiles)} existing company profiles")
